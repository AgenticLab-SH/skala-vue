...
수업에서 다루지 않은 지도와 태양 위치 계산처럼 처음 접하는 기술은 AI의 도움을 받아 조사했습니다. 제안받은 방법은 그대로 사용하지 않고 API 응답, 공식 예제, 브라우저 실행 결과와 직접 대조한 뒤 적용했습니다. 구현에 실제로 반영한 요청은 [사용한 프롬프트](https://agenticlab-sh.github.io/skala-vue/#/prompts)에 따로 정리했습니다.
