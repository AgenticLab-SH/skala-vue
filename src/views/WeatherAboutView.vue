  ...
  <div class="process-view">
    ...
    <section class="flow-section" aria-labelledby="flow-title">
      ...
      <ol>
        ...
        <li><span>6</span>전국 48개 지점의 강수량과 운량을 받아 날씨 지도에 표시합니다.</li>
        <li><span>7</span>날씨에 맞는 관광지 순서와 지도 지점 모션을 함께 계산합니다.</li>
      </ol>
    </section>
    ...
    <section class="limit-section">
      <p>현재 범위</p>
      <div>
        <h2>날씨 지역 비교와 관광지, 이동 경로를 함께 구현했습니다.</h2>
        <p>
          날씨 지도는 전국 48개 대표 지점의 현재 모델값을 비교하며 행정구역 경계나 기상 레이더는
          아닙니다. 관광지는 정적 후보라 실시간 영업 여부와 혼잡도는 확인하지 않습니다. 이동 지도는
          실제 도로 경로와 목적지 주변 3D 건물을 보여 줍니다.
        </p>
      </div>
    </section>
  </div>
