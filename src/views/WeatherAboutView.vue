...
<template>
  <div class="process-view">
    ...
    <section class="limit-section">
      <p>현재 범위</p>
      <div>
        <h2>날씨 효과와 이동선, 3D 건물까지 구현했습니다.</h2>
        <p>
          날씨 효과는 API 상태를 화면에 표현하지만 실제 강수량을 재현하지는 않습니다. 지도는 실제
          도로 경로를 보여 주지만 건물 그림자나 비가림 구간은 계산하지 않습니다. 그늘 우선 경로는
          건물 높이, 태양 위치, 보행 경로를 함께 계산해야 하므로 다음 단계로 남겼습니다.
        </p>
      </div>
    </section>
  </div>
