...
const troubleshooting = [
  {
    ...
    cause: '요청이 빠르게 끝나거나 애니메이션이 현재 화면 아래에서 나타났습니다.',
    fix: '기존 결과 위에 투명한 유리 레이어를 띄우고, 결과가 먼저 준비되어도 최소 1초 동안 탐색 애니메이션을 표시했습니다.',
  },
  {
  ...
  },
  {
    ...
    fix: '접속과 새로고침마다 표시하되 2초 후 닫도록 단순화하고, 그동안 첫 날씨 요청을 시작한 뒤 본문으로 포커스를 돌렸습니다.',
  },
  {
